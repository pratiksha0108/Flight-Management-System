...
public class MainScreen extends JFrame {
	...
	public MainScreen() {
		...
		// Button to navigate to the login type selection screen
		...
		// Creating instances of Flight class representing local flights
		...
		// Adding local flight objects to the flight list in LocalFlightSchedule class
		...
		// Creating instances of internationalFlight class representing international flights
